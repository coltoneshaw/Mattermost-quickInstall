...
find $MATTERMOST_INSTALL_DIR/ $MATTERMOST_INSTALL_DIR/client/ -mindepth 1 -maxdepth 1 \! \( -type d \( -path $MATTERMOST_INSTALL_DIR/client -o -path $MATTERMOST_INSTALL_DIR/client/plugins -o -path $MATTERMOST_INSTALL_DIR/config -o -path $MATTERMOST_INSTALL_DIR/logs -o -path $MATTERMOST_INSTALL_DIR/plugins -o -path $MATTERMOST_INSTALL_DIR/data \) -prune \) | sort | sudo xargs rm -r
